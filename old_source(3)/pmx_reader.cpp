...
)
{
	...
	//
	// Use the original texture resolution in the C4D editor
	// instead of the default preview scaling.
	// This affects the editor/viewport texture preview only.
	// It does not change the rendered texture resolution.
	// ========================================================
...
)
{
	...
	//
	// Cinema 4D R19:
	// BaseBitmap::Init() returns IMAGERESULT.
	// Do not use it directly as a Bool condition.
	// ========================================================
	...
	// Alpha mode
	//
	// 1. Texture has internal alpha:
	//    Use bitmap alpha.
	//
	// 2. Texture has no alpha but PMX diffuse alpha < 1:
	//    Use material alpha only.
	//    Do NOT connect bitmap to alpha.
	//
	// 3. Neither:
	//    Do not use alpha.
	// ========================================================
